...
test.each(defaultUrls)('should inject metadata for valid collections', async (defaultUrl) => {
  ...
  expect(body).toContain(`<meta property="og:title" content="Ring Exchange Interface"/>`)
  ...
  expect(body).toContain(`<meta property="og:image:alt" content="Ring Exchange Interface"/>`)
  expect(body).toContain(`<meta property="twitter:card" content="summary_large_image"/>`)
  expect(body).toContain(`<meta property="twitter:title" content="Ring Exchange Interface"/>`)
  expect(body).toContain(
    `<meta property="twitter:image" content="http://127.0.0.1:3000/images/1200x630_Rich_Link_Preview_Image.png"/>`
  )
  expect(body).toContain(`<meta property="twitter:image:alt" content="Ring Exchange Interface"/>`)
})
